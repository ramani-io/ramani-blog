    ...
    <Card className="py-4 w-3/4">
      <CardBody className="overflow-visible py-2">
        <Image
          ...
          src="https://images.unsplash.com/photo-1664575601786-b00156752b61?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2787&q=80"
          width={270}
        />
      </CardBody>
